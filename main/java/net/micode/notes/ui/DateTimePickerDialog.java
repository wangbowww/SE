...
public class DateTimePickerDialog extends AlertDialog implements DialogInterface.OnClickListener {
    ...
    public DateTimePickerDialog(Context context, long date) {
        ...
        setButton(BUTTON_POSITIVE, context.getString(R.string.datetime_dialog_ok), this); // 设置“确定”按钮
        setButton(BUTTON_NEGATIVE, context.getString(R.string.datetime_dialog_cancel), this); // 设置“取消”按钮
    ...
    public void set24HourView(boolean is24HourView) {
        ...
        mDateTimePicker.setIs24HourView(is24HourView);
    }
    ...
    public void onClick(DialogInterface dialog, int which) {
        if (which == BUTTON_POSITIVE && mOnDateTimeSetListener != null) { // 如果设置了监听器，调用其onDateTimeSet方法
